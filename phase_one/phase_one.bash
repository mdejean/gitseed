...
sudo /usr/local/bin/gotty -p 80 --timeout 60 ~/gitseed/phase_two/phase_two.bash &> /tmp/gotty.log &
disown -h
echo "The gotty log is at /tmp/gotty.log"
echo "Visit http://$(curl http://metadata.google.internal/computeMetadata/v1/instance/network-interfaces/0/access-configs/0/external-ip -H "Metadata-Flavor: Google") to continue!"
